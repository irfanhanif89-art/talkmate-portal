...
// Account history endpoint. Returns:
//  - jobs:  bookings where account_id = this account
//  - calls: calls where caller_phone matches any linked_number on the account
...
export async function GET(
  ...
  // Load the account first so we can extract linked phone numbers.
