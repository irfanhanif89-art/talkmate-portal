        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 1100 }}>
          <thead>
            <tr style={{ background: '#071829' }}>
              {['Business', 'Phone', 'Plan', 'Billing', 'Setup Fee', 'SMS / Mo', 'Industry', 'Status', 'Unread', 'KB', 'WB', 'Rv', 'Go-Live', 'Onboarded', 'Closed by rep', 'Created', 'Actions'].map(h => (
          ...
          <tbody>
            {filtered.length === 0 && (
              <tr>
                <td colSpan={17} style={{ padding: 28, textAlign: 'center' as const, fontSize: 13, color: '#7BAED4' }}>
